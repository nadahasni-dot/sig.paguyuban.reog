                ...
                <div class="col-12">
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            ...
                            <a class="text-info" href="<?= base_url('admin/pengguna?category=notverified') ?>">Not Verified (<?= count($notVerifiedUsers); ?>)</a> |
                            <a class="text-info" href="<?= base_url('admin/pengguna?category=admin') ?>">Admin (<?= count($adminUsers); ?>)</a> |
                            <a class="text-info" href="<?= base_url('admin/pengguna?category=paguyuban') ?>">Paguyuban (<?= count($paguyubanUsers); ?>)</a> |
                            <a class="text-info" href="<?= base_url('admin/pengguna?category=umum') ?>">Umum (<?= count($umumUsers); ?>)</a>
                        </div>
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="align-middle"><?= $user['status_user'] == 1 ? 'ACTIVE' : 'NOT VERIFIED' ?></td>
                                            <td class="align-middle">
                                                <?php
                                                if ($user['role'] == 1) {
                                                    echo 'ADMIN';
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="telephoneAdd">Phone</label>
                        <input id="telephoneAdd" type="tel" class="form-control" name="telepon_user" placeholder="Phone" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="statusAdd">Status User</label>
                        <select id="statusAdd" name="status_user" class="form-control select2" style="width: 100%;" required>
